...
urlpatterns = [
    ...
    path('following/me/', views.UserFollowingCreateListAPIView.as_view(), name='me-following'),
    path('following/<str:user_id>/', views.UserFollowingCreateListAPIView.as_view(), name='following'),
    path('follower/me/', views.UserFollowerListAPIView.as_view(), name='me-follower'),
